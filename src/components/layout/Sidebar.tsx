        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center justify-between text-[#94a3b8]/60 pt-2 border-t border-[#1e293b]">
            ...
            <div className="flex items-center gap-3">
              <a href="https://x.com/ArcSignal_" target="_blank" rel="noopener noreferrer" aria-label="ArcSignal on X" className="hover:text-[#ddb7ff] transition-colors text-[#94a3b8]/60">
                <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z" />
                </svg>
              </a>
              <a href="https://github.com/syther069/ArcSignal-" target="_blank" rel="noopener noreferrer" aria-label="ArcSignal on GitHub" className="hover:text-[#ddb7ff] transition-colors text-[#94a3b8]/60">
                <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
