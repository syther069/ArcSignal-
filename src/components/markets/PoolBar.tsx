...
export function PoolBar({ followPool, fadePool, className = '' }: PoolBarProps) {
  ...
  return (
    <div className={`w-full flex flex-col gap-2 ${className}`}>
      <div className="flex justify-between items-center text-[11px] font-mono uppercase tracking-[0.08em] text-gray-400">
        <span className="text-[#ddb7ff]">Follow Pool {formatUSDC(followPool)} USDC</span>
      ...
      <div className="w-full h-2.5 rounded-full overflow-hidden flex bg-[#262626]">
        <div 
          className="h-full bg-[#ddb7ff] transition-all duration-500 ease-out rounded-l-full"
